...
const Header: FC = ({ toggleCart, toggleCreate }) => {
  return (
    <div className="relative mt-3.5 h-14 py-0">
      ...
      <button
        ...
        className="absolute right-20 top-2 mr-2 rounded-lg bg-blue-700 px-5 py-3 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
      >
        Create
      </button>
